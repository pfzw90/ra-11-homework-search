...
import { map, tap, retry, filter, debounceTime, switchMap, catchError, distinct } from 'rxjs/operators';
import { CHANGE_SEARCH_FIELD, SEARCH_SKILLS_REQUEST } from '../actions/actionTypes';
import { searchSkillsRequest, searchSkillsSuccess, searchSkillsFailure, clearSearchField } from '../actions/actionCreators';
import { of } from 'rxjs';
